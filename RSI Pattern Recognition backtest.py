...
# https://github.com/messfin/quant-trading/blob/master/Bollinger%20Bands%20Pattern%20Recognition%20backtest.py
def pattern_recognition(df,method,lag=14):
    ...
    # https://github.com/messfin/quant-trading/blob/master/preview/rsi%20head-shoulder%20pattern.png
